...
def launch_fe(data):
    ...
    # Save the model
    model_name = "2038005c-3da0-4f40-8df1-af2238f24921"
    ...
    # Save the model
    model_name = "6b5934a3-6e67-45bc-8228-6c822df0f07f"
    fh = open(model_name, "wb")
    ...
    # Save the model
    model_name = "28cc0737-2eeb-4c54-b5b7-6fb65a0059ae"
    fh = open(model_name, "wb")
...
def get_model_id():
    return "28cc0737-2eeb-4c54-b5b7-6fb65a0059ae"
...
file1 = open("/content/drive/Shareddrives/1:1 Meenakshi Nair/CropYieldF_GBR.txt", "a")  # append mode
...
file1 = open("/content/drive/Shareddrives/1:1 Meenakshi Nair/CropYieldF_RNN.txt", "a")  # append mode
