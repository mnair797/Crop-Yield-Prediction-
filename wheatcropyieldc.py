...
def launch_fe(data):
    ...
    columns_list = ["heat_index_3", "heat_index_4", "apparentTemperatureMax", "apparentTemperatureMin", "dewPoint", "humidity", "precipIntensityMax", "temperatureMax", "temperatureMin", "NDVI", "Yield", "heat_index_0", "heat_index_1", "heat_index_2"]
...
file1 = open("/content/drive/Shareddrives/1:1 Meenakshi Nair/CropYieldC_GBR.txt", "a")  # append mode
...
file1 = open("/content/drive/Shareddrives/1:1 Meenakshi Nair/CropYieldC_RNN.txt", "a")  # append mode
