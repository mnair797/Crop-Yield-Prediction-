...
def launch_fe(data):
    ...
    # Save the model
    model_name = "df7d7f04-f665-43fb-a7f0-a588ca1024e5"
    ...
    # Save the model
    model_name = "70692f3a-e07e-4ca4-b480-b5189c3dfd59"
    fh = open(model_name, "wb")
    ...
    # Save the model
    model_name = "36c6bb80-5b2f-4d6a-8826-f169eea59b3e"
    fh = open(model_name, "wb")
...
def get_model_id():
    return "36c6bb80-5b2f-4d6a-8826-f169eea59b3e"
...
file1 = open("/content/drive/Shareddrives/1:1 Meenakshi Nair/CropYieldG_GBR.txt", "a")  # append mode
...
file1 = open("/content/drive/Shareddrives/1:1 Meenakshi Nair/CropYieldG_RNN.txt", "a")  # append mode
