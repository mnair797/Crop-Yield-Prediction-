...
def launch_fe(data):
    ...
    columns_list = ["pesticide_material_applied", "pesticide_material_quantity", "fertilizer_material_applied", "fertilizer_material_quantity", "planting_quantity", "tomato_mh_dry_yield_Mg/ha"]
    ...
    # Save the model
    model_name = "ab11956d-5735-4bdd-a52d-677f73368f60"
...
def get_model_id():
    return "ab11956d-5735-4bdd-a52d-677f73368f60"
...
pol_reg = linear_model.Lasso(alpha=0.1)
...
gbr = GradientBoostingRegressor(n_estimators=320, max_depth=5, learning_rate=0.005, min_samples_split=3)
gbr.fit(train.iloc[:,1:], train.iloc[:,0])
...
file1 = open("/content/drive/Shareddrives/1:1 Meenakshi Nair/CropYieldA_RNN.txt", "a")  # append mode
